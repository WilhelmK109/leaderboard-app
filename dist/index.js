 ...
 */
(self["webpackChunkleaderboard_app"] = self["webpackChunkleaderboard_app"] || []).push([["index"],{
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_add_players_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/add-players.js */ \"./src/modules/add-players.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\n\r\nconst players = [\r\n  {\r\n    name: 'Wilhelm',\r\n    score: 20,\r\n  },\r\n  {\r\n    name: 'David',\r\n    score: 15,\r\n  },\r\n  {\r\n    name: 'Willem',\r\n    score: 5,\r\n  },\r\n];\r\n\r\nconst displayPlayers = (players) => {\r\n  const playerList = document.getElementById('player-list');\r\n  playerList.innerHTML = '';\r\n  players.forEach((playerListItem) => {\r\n    const playerItem = document.createElement('li');\r\n    playerItem.className = 'player-item';\r\n    playerItem.innerHTML = `Name: ${playerListItem.name}`;\r\n    playerList.appendChild(playerItem);\r\n  });\r\n};\r\n\r\nwindow.addEventListener('load', () => {\r\n  displayPlayers(scores);\r\n  const refreshBtn = document.getElementById('refresh-btn');\r\n  refreshBtn.addEventListener('click', () => {\r\n    displayPlayers(players);\r\n  });\r\n  const submitBtn = document.getElementById('submit-btn');\r\n  submitBtn.addEventListener('click', (e) => {\r\n    e.preventDefault();\r\n    const inputName = document.getElementById('input-name');\r\n    const inputScore = document.getElementById('input-score');\r\n    addScore(inputName.value, inputScore.value, players);\r\n    inputName.value = '';\r\n    inputScore.value = '';\r\n    displayPlayers(players);\r\n  });\r\n});\n\n//# sourceURL=webpack://leaderboard-app/./src/index.js?");

/***/ }),

/***/ "./src/modules/add-players.js":
/*!************************************!*\
  !*** ./src/modules/add-players.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst addNewPlayer = (name, score, prayerList) => {\r\n  const newPlayer = {\r\n    name,\r\n    score,\r\n  };\r\n  scoreList.push(newPlayer);\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addNewPlayer);\n\n//# sourceURL=webpack://leaderboard-app/./src/modules/add-players.js?");
